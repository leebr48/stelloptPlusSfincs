# This script reads profile data from the BEAMS3D section of the STELLOPT namelist and converts it to a SFINCS-readable profiles file. FIXME description when finished #FIXME all comments and descriptions in this script
...
parser.add_argument('--numRad', type=float, nargs=1, required=False, default=[1000], help='Number of radial surfaces on which to calculate interpolated profile data. This number should be quite large (default = 1000).')
