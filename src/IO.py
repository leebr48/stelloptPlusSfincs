...
def getRunArgs():
    ...
    parser.add_argument('--assumedSpeciesMass', type=float, nargs=1, required=False, default=[9.109383701528e-31], help='Mass in kg of a species that will be included in the SFINCS run(s) regardless of what other species the STELLOPT profiles file specifies. Due to STELLLOPT defaults, this should always be electrons. This option is included for completeness, but you should probably never change it.')
    parser.add_argument('--assumedSpeciesCharge', type=float, nargs=1, required=False, default=[-1.0], help='Charge in units of the proton charge of a species that will be included in the SFINCS run(s) regardless of what other species the STELLOPT profiles file specifies. Due to STELLLOPT defaults, this should always be electrons. This option is included for completeness, but you should probably never change it.')
