...
def getRunArgs():
    ...
    parser.add_argument('--bcSymmetry', type=str, nargs=1, required=False, default=['sym'], help='If one or more *.bc files are input via <eqIn>, this setting will control whether SFINCS assumes them to be stellarator-symmetric ("sym") or stellarator-asymmetric ("asym").')
    ...
    if args.bcSymmetry[0] not in ['sym', 'asym']:
        raise IOError('<bcSymmetry> must be set to either "sym" or "asym".')
