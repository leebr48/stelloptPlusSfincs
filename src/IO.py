...
def getPlotArgs():
    ...
    parser.add_argument('--saveLoc', type=str, nargs='*', required=False, default=[None], help='Location(s) in which to save plots. Defaults to <sfincsDir>/plots/. If you input multiple directories, order matters!')
