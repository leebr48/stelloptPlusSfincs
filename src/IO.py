...
def getRunArgs():
    ...
    parser.add_argument('--time', type=str, nargs=1, required=False, default=['00-06:00:00'], help='Wall clock time limit for the batch runs. Format is DD-HH:MM:SS.')
...
def getPlotArgs():
    ...
    parser.add_argument('--saveLoc', type=str, nargs='*', required=False, default=[None], help='Location(s) in which to save plots and plot data. Defaults to <sfincsDir>/plots/. If you input multiple directories, order matters!')
