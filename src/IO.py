...
def getArgs():
    ...
    parser.add_argument('--Nzeta', type=int, nargs=1, required=False, default=[35], help='Number of toroidal grid points per period. This should be an odd number.')
    ...
    parser.add_argument('--Ntheta', type=int, nargs=1, required=False, default=[15], help='Number of poloidal grid points. This should be an odd number.')
